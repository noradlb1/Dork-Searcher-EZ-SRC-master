...
Namespace Searcher.Parser.Service.Rambler
    Friend Class Rambler
        Private ReadOnly _save As SaveResult = New SaveResult()

        Private ReadOnly _set As Setting = Setting.GetRambler()
        ...
        Private Function Connector(ByVal line As String, ByVal proxy As String, ByVal str As Integer) As String
            ...
            Using httpRequest As xNet.HttpRequest = New xNet.HttpRequest()
                ...
                httpRequest.Cookies.Add("sort", Me._set.DopSort.ToString())
                httpRequest.Cookies.Add("pagelen", "50")
                httpRequest.Cookies.Add("am", Me._set.Dop18)
                httpRequest.Cookies.Add("lang", Me._set.DopLang)
                ...
                Dim str2 As String = ""
                Try
                    str2 = httpRequest.[Get](String.Concat(New Object() {"https://nova.rambler.ru/search_more?query=", line, "&suggest=false&page=", str + 1}), Nothing).ToString()
                    If (str2.Contains("rambler.ru")) Then
                        Dim matchCollections As MatchCollection = Regex.Matches(str2, "class=""b-serp-item__link"" href=""(\S{1,500})"" onmouseup=")
        ...
        Public Sub CreateThread()
            Me.GetSetting()
            Me._message.Message("Get setting Rambler.", 0)
            Dim num As Integer = 0
            Do
            ...
            Me._message.Message("Start parsing with Rambler.", 0)
        End Sub
