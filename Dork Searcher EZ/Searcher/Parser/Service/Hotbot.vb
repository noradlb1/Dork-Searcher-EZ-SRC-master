    ...
    Friend Class Hotbot
        ...
        Private Function Connector(ByVal line As String, ByVal proxy As String, ByVal str As Integer) As String
            ...
            Using httpRequest As xNet.HttpRequest = New xNet.HttpRequest()
                ...
                Dim str2 As String = ""
                Try
                    str2 = httpRequest.[Get](String.Concat(New Object() {"https://www.hotbot.com/search?query=", line, "&page=", str + 1}), Nothing).ToString()
                    If (str2.Contains("hotbot.com")) Then
                        Dim matchCollections As MatchCollection = Regex.Matches(str2, "<h3 class=""title"">" & vbCrLf & "          <a href=""(\S{5,500})"">")
        ...
        Public Sub CreateThread()
            Me.GetSetting()
            Me._message.Message("Get setting HotBot.", 0)
            Dim num As Integer = 0
            Do
            ...
            Me._message.Message("Start parsing with HotBot.", 0)
        End Sub
