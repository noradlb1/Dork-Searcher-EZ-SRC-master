    ...
    Friend Class Ask
        ...
        Private Function Connector(ByVal line As String, ByVal proxy As String, ByVal str As Integer) As String
            ...
            Using httpRequest As xNet.HttpRequest = New xNet.HttpRequest()
                ...
                Dim str2 As String = ""
                Try
                    str2 = httpRequest.[Get](String.Concat(New Object() {"www.ask.com/web?q=", line, "&page=", str + 1}), Nothing).ToString()
                    If (str2.Contains("Your client does not have permission to access this site.") OrElse Not str2.Contains("ask.com")) Then
                        ...
                        str1 = "Error"
                    Else
                        Dim matchCollections As MatchCollection = Regex.Matches(str2, "<a class=""web-result-title-link"" href=""(\S{5,500})""")
        ...
        Public Sub CreateThread()
            Me.GetSetting()
            Me._message.Message("Get setting Ask.", 0)
            Dim num As Integer = 0
            Do
            ...
            Me._message.Message("Start parsing with Ask.", 0)
        End Sub
