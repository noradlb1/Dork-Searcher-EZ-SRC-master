    ...
    Friend Class Ecosia
        ...
        Private Function Connector(ByVal line As String, ByVal proxy As String, ByVal str As Integer) As String
            ...
            Using httpRequest As xNet.HttpRequest = New xNet.HttpRequest()
                ...
                httpRequest.Cookies.Add("ECFG", "ECFG=a=0:as=0:cs=1:dt=pc:f=n:l=en:lt=1488635400:mc=en-us:nt=0:t=1:fs=0:fr=0:nf=0:tt=0:ps=0;")
                Dim str2 As String = ""
                Try
                    str2 = httpRequest.[Get](String.Concat(New Object() {"https://www.ecosia.org/search?p=", str, "&q=", line}), Nothing).ToString()
                    If (str2.Contains("ecosia.org")) Then
                        Dim matchCollections As MatchCollection = Regex.Matches(str2, "js-result-title"" href=""(\S{5,500})"">")
        ...
        Public Sub CreateThread()
            Me.GetSetting()
            Me._message.Message("Get setting Ecosia.", 0)
            Dim num As Integer = 0
            Do
            ...
            Me._message.Message("Start parsing with Ecosia.", 0)
        End Sub
