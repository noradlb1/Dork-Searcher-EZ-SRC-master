    ...
    Friend Class Teoma
        ...
        Private Function Connector(ByVal line As String, ByVal proxy As String, ByVal str As Integer) As String
            ...
            Using httpRequest As xNet.HttpRequest = New xNet.HttpRequest()
                ...
                Dim str2 As String = ""
                Try
                    str2 = httpRequest.[Get](String.Concat(New Object() {"http://www.teoma.com/web?q=", line, "&page=", str + 1}), Nothing).ToString()
                    If (str2.Contains("Your client does not have permission to get the requested") OrElse Not str2.Contains("teoma.com")) Then
        ...
        Public Sub CreateThread()
            Me.GetSetting()
            Me._message.Message("Get setting Teoma.", 0)
            Dim num As Integer = 0
            Do
            ...
            Me._message.Message("Start parsing with Teoma", 0)
        End Sub
