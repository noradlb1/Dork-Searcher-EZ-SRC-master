    ...
    Friend Class MyWebSearch
        ...
        Private Function Connector(ByVal line As String, ByVal proxy As String, ByVal str As Integer) As String
            ...
            Using httpRequest As xNet.HttpRequest = New xNet.HttpRequest()
                ...
                Dim str2 As String = ""
                Try
                    str2 = httpRequest.[Get](String.Concat(New Object() {"http://int.search.mywebsearch.com/mywebsearch/GGweb.jhtml?searchfor=", line, "&pn=", str + 1}), Nothing).ToString()
                    If (str2.Contains("mywebsearch.com")) Then
                        Dim matchCollections As MatchCollection = Regex.Matches(str2, "<a class=""algo-title "" href=""(\S{5,500})""")
        ...
        Public Sub CreateThread()
            Me.GetSetting()
            Me._message.Message("Get setting MyWebSearch.", 0)
            Dim num As Integer = 0
            Do
            ...
            Me._message.Message("Get setting with MyWebSearch.", 0)
        End Sub
