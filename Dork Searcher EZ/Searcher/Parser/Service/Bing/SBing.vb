...
Namespace Searcher.Parser.Service.Bing
    Friend Class SBing
        ...
        Private ReadOnly _getbing As Setting = Setting.GetBing()
        ...
        Private Function Connector(ByVal line As String, ByVal proxy As String, ByVal str As Integer) As String
            ...
            Using httpRequest As xNet.HttpRequest = New xNet.HttpRequest()
                ...
                httpRequest.Cookies.Add("SRCHHPGUSR", String.Concat(New String() {"CW=1024&CH=768&DPR=1&UTC=180&NEWWND=0&NRSLT=50&SRCHLANG=", Me.lang, "&AS=1&ADLT=", Me.dop18, "&NNT=1&HIS=0&HAP=2"}))
                httpRequest.IgnoreProtocolErrors = True
                httpRequest.UserAgent = "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/535.39"
                httpRequest.AddHeader("Upgrade-Insecure-Requests", "1")
                httpRequest.AddHeader("Accept", "*/*")
                httpRequest.AddHeader("Accept-Language", "ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4")
                Dim str2 As String = ""
                Try
                    str2 = httpRequest.[Get](String.Concat(New Object() {"http://www.bing.com/search?q=", line, "&first=", str * 50, "&count=50&setmkt=", Me.region}), Nothing).ToString()
                    If (str2.Contains("bing.com")) Then
                        Dim matchCollections As MatchCollection = Regex.Matches(str2, "<h2><a href=""(\S{5,500})""")
                        For Each match As System.Text.RegularExpressions.Match In matchCollections
                            If (match.Result("$1").Contains("bs.yandex.")) Then
                                Continue For
                            End If
                            ...
                            End SyncLock
                        Next
                        If (matchCollections.Count >= 5) Then
        ...
        Public Sub CreateThread()
            Me.GetSetting()
            Me._message.Message("Get setting Bing.", 0)
            Dim num As Integer = 0
            Do
            ...
            Me._message.Message("Start parsing with Bing.", 0)
        End Sub
        ...
        Private Sub GetSetting()
            ...
            Me.lang = Me._getbing.DopLang
            Me.dop18 = Me._getbing.Dop18
            Me.region = Me._getbing.DopRegion
        End Sub
    End Class
End Namespace