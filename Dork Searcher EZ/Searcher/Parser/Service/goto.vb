    ...
    Friend Class [goto]
        ...
        Private Function Connector(ByVal line As String, ByVal proxy As String, ByVal str As Integer) As String
            ...
            Using httpRequest As xNet.HttpRequest = New xNet.HttpRequest()
                ...
                Dim str2 As String = ""
                Try
                    str2 = httpRequest.[Get](String.Concat(New Object() {"http://www.goto.com/index.php?q=", line, "&x=0&y=0&p=", str + 1}), Nothing).ToString()
                    If (str2.Contains("goto.com")) Then
                        Dim matchCollections As MatchCollection = Regex.Matches(str2, "<br><i>(\S{5,500})</i></li>")
        ...
        Public Sub CreateThread()
            Me.GetSetting()
            Me._message.Message("Get setting GoTo.", 0)
            Dim num As Integer = 0
            Do
            ...
            Me._message.Message("Start parsing with GoTo.", 0)
        End Sub
