    ...
    Friend Class WOW
        ...
        Private Function Connector(ByVal line As String, ByVal proxy As String, ByVal str As Integer) As String
            ...
            Using httpRequest As xNet.HttpRequest = New xNet.HttpRequest()
                ...
                Dim str2 As String = ""
                Try
                    str2 = httpRequest.[Get](String.Concat(New Object() {"http://search.wow.com/search?v_t=na&q=", line, "&page=", str + 1}), Nothing).ToString()
                    If (str2.Contains("wow.com")) Then
        ...
        Public Sub CreateThread()
            Me.GetSetting()
            Me._message.Message("Get setting WoW.", 0)
            Dim num As Integer = 0
            Do
            ...
            Me._message.Message("Start parsing with WoW.", 0)
        End Sub
